      ...
      <div className="container py-20">
        <div className="grid md:grid-cols-4 gap-12">
          <ScrollReveal direction="up" className="md:col-span-2">
            <EditableText contentKey="footer.brand" defaultValue="Binyan Adam" as="h3" className="text-3xl font-serif mb-4 text-foreground" />
          ...
          <ScrollReveal direction="up" delay={0.1}>
            <EditableText contentKey="footer.servicesTitle" defaultValue={t.footer.servicesTitle} as="h4" className="text-[11px] font-sans uppercase tracking-[0.2em] mb-6 text-muted-foreground" />
            <nav className="flex flex-col gap-3 text-sm">
              <Link to="/education" className="text-foreground/50 hover:text-primary transition-colors duration-300">
                <EditableText contentKey="footer.link.education" defaultValue={t.footer.links.education} />
              </Link>
              <Link to="/therapy" className="text-foreground/50 hover:text-primary transition-colors duration-300">
                <EditableText contentKey="footer.link.therapy" defaultValue={t.footer.links.therapy} />
              </Link>
              <Link to="/families" className="text-foreground/50 hover:text-primary transition-colors duration-300">
                <EditableText contentKey="footer.link.families" defaultValue={t.footer.links.families} />
              </Link>
              <Link to="/organisations" className="text-foreground/50 hover:text-primary transition-colors duration-300">
                <EditableText contentKey="footer.link.organisations" defaultValue={t.footer.links.organisations} />
              </Link>
              <Link to="/supervision" className="text-foreground/50 hover:text-primary transition-colors duration-300">
          ...
          <ScrollReveal direction="up" delay={0.2}>
            <EditableText contentKey="footer.contactTitle" defaultValue={t.footer.contactTitle} as="h4" className="text-[11px] font-sans uppercase tracking-[0.2em] mb-6 text-muted-foreground" />
            <div className="flex flex-col gap-3 text-sm text-foreground/50">
              ...
              <a className="hover:text-primary transition-colors duration-300" href="mailto:adamdayan@bacbs.com">
