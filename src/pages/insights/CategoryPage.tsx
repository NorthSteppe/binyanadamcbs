    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-28 pb-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-2">{category?.name || "Category"}</h1>
          {category?.description && <p className="text-lg text-muted-foreground mb-10">{category.description}</p>}
          ...
          {posts?.length === 0 && <p className="text-center text-muted-foreground py-12">No articles in this category yet.</p>}
        </div>
      </div>
      <Footer />
    </div>
