...
const Messages = () => {
  ...
  const handleSend = async () => {
    ...
    setSending(true);
    // For now, messages go to a general admin - in production this would be the practitioner's ID
    // We send to self as a placeholder (admin will reply)
      ...
      <section className="pt-28 pb-8 flex-1 flex flex-col">
        <div className="container flex-1 flex flex-col">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="text-muted-foreground mb-6">{portalT.messagesSubtitle || "Communicate securely with your practitioner."}</p>
          </motion.div>
