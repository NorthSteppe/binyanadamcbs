      ...
      <section className="pt-28 pb-20">
        <div className="container max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-2">{portalT.staffMatrixTitle || "ACT Matrix"}</h1>
            <p className="text-muted-foreground mb-10">{portalT.staffMatrixDesc || "Fill in ACT Matrix for your assigned clients."}</p>
          </motion.div>
