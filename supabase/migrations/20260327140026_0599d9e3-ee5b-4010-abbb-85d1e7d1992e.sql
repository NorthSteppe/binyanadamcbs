...
BEGIN
  ...
  IF unsub_token IS NULL THEN
    unsub_token := replace(gen_random_uuid()::text || gen_random_uuid()::text, '-', '');
...
VALUES (
  '4eaa7a65-a28b-48ce-b767-3306d784d4f2',
  'admin',
  'Email Delivery Test',
  'If you receive this email, notification emails are working correctly!',
  '/portal/dashboard'
);
